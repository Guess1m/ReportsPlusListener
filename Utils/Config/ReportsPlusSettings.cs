...
namespace ReportsPlus.Utils.Config
{
    ...
    [ConfigHeader("ReportsPlus", "Author: Guess1m", "Config Version: 2.0.3", "I recommend you do not edit this file manually, instead use the in-game menu to edit the settings.")]
